...
# By Tom Spark | Open Source | https://github.com/tomspark
# ============================================================
...
function Write-Banner {
    ...
    Write-Host "              Version $script:Version | Tom Spark" -ForegroundColor DarkGray
    Write-Host "  =====================================================" -ForegroundColor Cyan
    Write-Host ""
}
...
# Generated by Privacy Box Setup Script
# ==========================================
